...
class InstructionMetric(RegressionMetric):
    """InstructionMetric:
    ...
    def __init__(
        ...
        self.estimator = FeedForward(
            in_dim=self.encoder.output_units * 1,
    ...
    def forward(
        ...
        **kwargs
        ...
        # )
        return Prediction(score=self.estimator(src_sentemb).view(-1))
