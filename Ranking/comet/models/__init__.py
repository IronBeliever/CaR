...
from .ranking.instruction_ranking_metric import InstructionRankingMetric
from .regression.referenceless import ReferencelessRegression
from .regression.regression_metric import RegressionMetric
from .regression.instruction_metric import InstructionMetric
...
str2model = {
    ...
    "instruction_ranking_metric": InstructionRankingMetric,
